...
from users import *
from keyboards import kb_quiz_maker, next_kb, start_menu_kb, train_kb, options_kb, return_kb, store_kb, items_kb, \
    goto_store_kb
...
def start(message: Message):
    bot.send_message(message.chat.id,
                     'Это главное меню. Дальнейшая навигация производиться с помощью кнопок.',
